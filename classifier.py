...
checkpoint = ModelCheckpoint("models/inout_classifier.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only=True,
                             verbose=1)
...
face_classifier.save("models/inout.h5")

# Testing
def test_image_classifier_with_folder(model, path, y_true, img_height=250, img_width=250, class_names=['in', 'out']):
...
test_image_classifier_with_folder(face_classifier,
                                  'datasets/test_images/in',
                                  y_true='in')

test_image_classifier_with_folder(face_classifier,
                                  'datasets/test_images/out',
                                  y_true='out')
